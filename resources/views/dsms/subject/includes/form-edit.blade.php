...
dm_input('text','credit_hour', "Subject Credit Hour(<em style='color:red'>*</em>)", $data['single']->credit_hour);
dm_input('text','theory_full_marks', "Subject Theory Full Marks(<em style='color:red'>*</em>)", $data['single']->theory_full_marks);
