                     ...
                     <page size="A4" style="border-style:double; padding:20px;" >
                        ...
                        <table>
                            <thead>
                             ...
                             {{-- Logic  --}}
                             @php
                                $percentage = $total_grade_credit_hour/($count * 4);
                             @endphp
                             <tfoot>
                                 <tr>
 ...
 <div id="all-gradesheet-pdf" hidden>
     <page size="A4" style="border-style:double; padding:20px;" >
         <div class="row report-header">
             <div class="col-md-12 ">
                 <div class="col-md-2">
                 ...
                 <div class="col-md-8" style="top:-26px;">
                     <div class="pull-center">
                         ...
                         @endif
                         <h5>@if(isset( $data['class_id'])) {{ dm_getClass($data['class_id'])->title }} @endif</h5>
                         <h4 style="text-decoration: underline;;"><b>Marks-Sheet</b></h4>
                     </div>
                 </div>
         ...
         <div class="para">
                     <p>The percentage secured by <b>{{ dm_getStudent($key)->first_name }}</b> Date of Birth <b>{{ dm_getStudent($key)->dob_bs }}&nbsp;BS({{ dm_getStudent($key)->dob_ad }}&nbsp;AD)</b> Symbol number <b>{{ dm_getStudent($key)->roll_no }}</b> of<b>@if(isset( $data['school_id'])) {{ dm_getSchool($data['school_id'])->title }} @endif</b> in basic education completion examination given below.
             </p>
         </div>
