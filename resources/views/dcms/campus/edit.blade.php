        ...
        <div class="col-lg-8 col-md-8 col-xs-8">
            <section class="panel">
                ...
                <div class="panel-body">
                    <?php
                        dm_dropdown('province','Province(<em style="color:red">*</em>)', $data['province'], $data['single']->province_id, $data['single']->campusCategory->name);
                    ?>
                </div>
            </section>
            <!--tab nav start-->
        ...
        <div class="col-lg-4 col-md-4 col-xs-4">
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    <?php
                    dm_inputUpdate('text', 'level', 'Campus Level', $data['single']->level, '');
                    ?>
                </div>
            </section>
        </div>
